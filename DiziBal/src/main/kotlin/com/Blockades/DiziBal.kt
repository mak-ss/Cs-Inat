...
class DiziBal : MainAPI() {
            ...
            when (type) {
                TvType.Movie -> {
                    ...
                    episodeElements.forEach { epElement ->
                        ...
                        val parsed = parseEpisodeInfo(epInfo) ?: parseEpisodeInfo(epName)
    ...
    override suspend fun loadLinks(
        ...
        return try {
            ...
            for (selector in listOf("[data-pv]", "[data-player]", "[data-video]", "[data-src]", "[data-id]", "[data-hash]")) {
                val el = document.selectFirst(selector) ?: continue
                val candidate = el.attr("data-pv").ifBlank { null }
            ...
            // 2) Player ID yoksa doğrudan iframe dene
    ...
    // Birden fazla format: "1. Sezon 5. Bölüm", "S01E05", "1x05", "5. Bölüm"
